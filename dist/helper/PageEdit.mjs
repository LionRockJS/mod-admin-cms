...
class Merger {
    ...
    static mergeItems(targetItems = {}, sourceItems = {}) {
        ...
        itemTypes.forEach(itemType => {
            result[itemType] = this.mergeItemArrays(targetItems[itemType] || [], sourceItems[itemType] || []);
        });
        return result;
    }
}
export default class HelperPageEdit {
    ...
    static postToOriginal($_POST, langauge = "en") {
        ...
        blockPosts.forEach((post, index) => {
            original.blocks[index] = this.mergeOriginals(original.blocks[index] || HelperPageText.defaultOriginal(), this.postToOriginal(post, langauge));
    ...
    static getOriginal(page, attributes = {}, state = new Map()) {
        ...
        if (!page.original)
            return HelperPageText.defaultOriginal();
